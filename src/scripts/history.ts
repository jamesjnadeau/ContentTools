...
ContentTools.History = class History {
    declare _delayedStoreRequested: any;
    declare _delayedStoreTimeout: any;
    declare _lastSnapshotTaken: any;
    declare _regions: any;
    declare _snapshotIndex: any;
    declare _snapshots: any;
    declare _watchInterval: any;
