...
ContentTools.DialogUI = class DialogUI extends ContentTools.WidgetUI {
    ...
    declare _domBusy: any;
    declare _domCaption: any;
    declare _domClose: any;
    declare _domControls: any;
    declare _domElement: any;
    declare _domView: any;
    declare _handleEscape: any;
    ...
    mount() {
        ...
        this._domElement = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(dialogCSSClasses);
        this.parent().domElement().appendChild(this._domElement);

        // Add the dialog header
        const domHeader = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-dialog__header']);
        this._domElement.appendChild(domHeader);

        // Caption
        this._domCaption = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-dialog__caption']);
        domHeader.appendChild(this._domCaption);
        this.caption(this._caption);

        // Close button
        this._domClose = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-dialog__close']);
        domHeader.appendChild(this._domClose);

        // Body
        const domBody = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-dialog__body']);
        this._domElement.appendChild(domBody);

        // View
        this._domView = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-dialog__view']);
        domBody.appendChild(this._domView);

        // Controls
        this._domControls = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-dialog__controls']);
        domBody.appendChild(this._domControls);

        // Busy
        this._domBusy = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-dialog__busy']);
