...
ContentTools.ImageDialog = class ImageDialog extends ContentTools.DialogUI {
    declare _cropMarks: any;
    declare _domCancelUpload: any;
    declare _domClear: any;
    declare _domCrop: any;
    declare _domImage: any;
    declare _domInput: any;
    declare _domInsert: any;
    declare _domProgress: any;
    declare _domRotateCCW: any;
    declare _domRotateCW: any;
    declare _domUpload: any;
    declare _imageSize: any;
    declare _imageURL: any;
    ...
    mount() {
        ...
        const domTools = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(
            ['ct-control-group', 'ct-control-group--left']);
        this._domControls.appendChild(domTools);

        // Rotate CCW
        this._domRotateCCW = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--icon',
        ...
        // Rotate CW
        this._domRotateCW = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--icon',
        ...
        // Rotate CW
        this._domCrop = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--icon',
            'ct-control--crop'
            ]);
        ...
        // Progress bar
        const domProgressBar = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-progress-bar']);
        domTools.appendChild(domProgressBar);

        this._domProgress = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-progress-bar__progress']);
        domProgressBar.appendChild(this._domProgress);

        // Actions
        const domActions = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(
            ['ct-control-group', 'ct-control-group--right']);
        this._domControls.appendChild(domActions);

        // Upload button
        this._domUpload = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--text',
            'ct-control--upload'
            ]);
        ...
        // Insert
        this._domInsert = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--text',
            'ct-control--insert'
            ]);
        ...
        // Cancel
        this._domCancelUpload = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--text',
            'ct-control--cancel'
            ]);
        ...
        // Clear
        this._domClear = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--text',
            'ct-control--clear'
            ]);
    ...
    populate(imageURL, imageSize) {
        ...
        if (!this._domImage) {
            this._domImage = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-image-dialog__image']);
...
class CropMarksUI extends ContentTools.AnchoredComponentUI {
    declare _bounds: any;
    declare _domClipper: any;
    declare _domElement: any;
    declare _domHandles: any;
    declare _domRulers: any;
    declare _dragging: any;
    declare _draggingOrigin: any;
    declare _imageSize: any;
    declare _onMouseMove: any;
    declare _onMouseUp: any;
    ...
    mount(domParent, before=null) {
        // Crop marks
        this._domElement = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-crop-marks']);

        // Clippers
        this._domClipper = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-crop-marks__clipper']);
        this._domElement.appendChild(this._domClipper);

        // Rulers
        this._domRulers = [
            (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
