...
(function() {
    ...
    declare _domButton: any;
    declare _domInput: any;
    declare _domTargetButton: any;
    declare _href: any;
    declare _target: any;
        ...
        mount() {
            ...
            this._domTargetButton = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            ...
            this._domButton = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-anchored-dialog__button']);
        ...
        save() {
            ...
            const detail = {href: this._domInput.value.trim()} as Record<string, any>;
            if (this._target) {
