...
ContentTools.PropertiesDialog = class PropertiesDialog extends ContentTools.DialogUI {
    declare _attributeUIs: any;
    declare _caption: any;
    declare _domApply: any;
    declare _domAttributes: any;
    declare _domAttributesTab: any;
    declare _domCode: any;
    declare _domCodeTab: any;
    declare _domInnerHTML: any;
    declare _domRemoveAttribute: any;
    declare _domStyles: any;
    declare _domStylesTab: any;
    ...
    changedAttributes() {
        ...
        for (var attributeUI of Array.from<any>(this._attributeUIs)) {
    ...
    changedStyles() {
        ...
        const styles = {};
        for (var styleUI of Array.from<any>(this._styleUIs)) {
    ...
    mount() {
        ...
        // Styles
        this._domStyles = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-properties-dialog__styles']);
        ...
        // Attributes
        this._domAttributes = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(
        ...
        for (name of Array.from<any>(attributeNames)) {
            value = attributes[name];
        ...
        // Code
        this._domCode = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-properties-dialog__code']);
        ...
        // Tabs
        const domTabs = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(
            ['ct-control-group', 'ct-control-group--left']);
        this._domControls.appendChild(domTabs);

        // Styles
        this._domStylesTab = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--icon',
            'ct-control--styles'
            ]);
        ...
        // Code
        this._domCodeTab = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--icon',
            'ct-control--code'
            ]);
        ...
        this._domRemoveAttribute = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--icon',
            'ct-control--remove',
            'ct-control--muted'
    ...
    _addDOMEventListeners() {
        ...
        const selectTab = selected => {
            ...
            for (var tab of Array.from<any>(tabs)) {
                if (tab === selected) {
                    continue;
                }
...
class StyleUI extends ContentTools.AnchoredComponentUI {
    ...
    mount(domParent, before=null) {
        ...
        // Section
        this._domElement = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-section']);
        if (this._applied) {
            ContentEdit.addCSSClass(this._domElement, 'ct-section--applied');
        }

        // Label
        const label = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-section__label']);
        label.textContent = this.style.name();
        this._domElement.appendChild(label);

        // Switch
        this._domElement.appendChild((this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-section__switch']));
...
class AttributeUI extends ContentTools.AnchoredComponentUI {
    declare _domElement: any;
    declare _domName: any;
    declare _domValue: any;
    declare _initialName: any;
    declare _initialValue: any;
    ...
    mount(domParent, before=null) {
        ...
        // Attribute
        this._domElement = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-attribute']);
