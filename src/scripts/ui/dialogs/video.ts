...
ContentTools.VideoDialog = class VideoDialog extends ContentTools.DialogUI {
    ...
    declare _domPreview: any;
    declare _updatePreviewTimeout: any;
    ...
    mount() {
        ...
        // Add controls
        const domControlGroup = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-control-group']);
        ...
        // Insert button
        this._domButton = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-control',
            'ct-control--text',
            'ct-control--insert',
            'ct-control--muted'
