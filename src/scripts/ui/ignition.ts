...
ContentTools.IgnitionUI = class IgnitionUI extends ContentTools.WidgetUI {
    ...
    declare _domCancel: any;
    declare _domConfirm: any;
    declare _domEdit: any;
    declare _domElement: any;
    declare _revertToState: any;
    declare _state: any;
    ...
    mount() {
        ...
        // Edit button
        this._domEdit = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-ignition__button',
        ...
        // Confirm button
        this._domConfirm = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-ignition__button',
        ...
        // Cancel button
        this._domCancel = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-ignition__button',
        ...
        // Busy
        this._domBusy = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-ignition__button',
