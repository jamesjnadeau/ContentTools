...
ContentTools.ToolboxUI = class ToolboxUI extends ContentTools.WidgetUI {
    ...
    declare _domGrip: any;
    declare _domToolGroups: any;
    declare _dragging: any;
    declare _draggingOffset: any;
    declare _handleKeyDown: any;
    declare _handleResize: any;
    declare _lastUpdateElement: any;
    declare _lastUpdateHistoryIndex: any;
    declare _lastUpdateHistoryLength: any;
    declare _lastUpdateSelection: any;
    declare _resizeTimeout: any;
    declare _toolUIs: any;
    declare _tools: any;
    declare _updateTools: any;
    declare _updateToolsInterval: any;
    ...
    mount() {
        ...
        // Grip
        this._domGrip = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv([
            'ct-toolbox__grip',
            'ct-grip'
            ]);
        this._domElement.appendChild(this._domGrip);

        this._domGrip.appendChild((this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-grip__bump']));
        this._domGrip.appendChild((this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-grip__bump']));
        this._domGrip.appendChild((this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-grip__bump']));

        // Tools
        this._domToolGroups = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-tool-groups']);
    ...
    tools(tools) {
        ...
        return (() => {
            ...
            // Create a group for the tools
                ...
                var domToolGroup = (this.constructor as unknown as {createDiv(classNames?: string[], attributes?: Record<string, string>, content?: string): HTMLDivElement}).createDiv(['ct-tool-group']);
                this._domToolGroups.appendChild(domToolGroup);

                // Create an associated ToolUI compontent for each tool in the group
                result.push((() => {
                    const result1 = [];
                    for (toolName of Array.from<any>(toolGroup)) {
