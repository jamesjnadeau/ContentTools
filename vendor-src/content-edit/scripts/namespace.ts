...
import type {ContentEditNamespace} from '../../../src/core/namespaces.js';
...
const ContentEdit = {
    ...
    addCSSClass(domElement, className) {
        ...
        if (classAttr) {
            ...
            const classNames = (Array.from<any>(classAttr.split(' ')));
    ...
    attributesToString(attributes) {
        ...
        for (name of Array.from<any>(names)) {
...
} as unknown as ContentEditNamespace;
