...
class _Root extends ContentEdit.Node {
    ...
    declare _draggingDOMElement: any;
    declare _dropTarget: any;
    declare _focused: any;
    declare _resizing: any;
    declare _resizingInit: any;
    declare _resizingParentWidth: any;
    ...
    _onDrag(ev) {
        ...
        if (this._dropTarget) {
            ...
            if (Array.from<any>(this._dragging.constructor.placements).includes(placement[0])) {
                this._dropTarget._addCSSClass(`ce-element--drop-${ placement[0] }`);
            }

            if (Array.from<any>(this._dragging.constructor.placements).includes(placement[1])) {
