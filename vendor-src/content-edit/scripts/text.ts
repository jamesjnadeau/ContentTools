 ...
 */
let Cls$text: any = (ContentEdit.Text = class Text extends ContentEdit.Element {    declare _domElement: any;
    declare _dragTimeout: any;
    declare _savedSelection: any;

    static declare _cached: any;
    static declare _lastCached: any;
    static declare content: any;
    ...
    _keyReturn(ev) {
        ...
        if (this.content.isWhitespace() &&
                (Number(!ev.shiftKey) ^ Number(ContentEdit.PREFER_LINE_BREAKS))) {
            return;
        }
        ...
        const element = new (this.constructor as unknown as new (...a: any[]) => any)('p', {}, tail.trim());
...
Cls$text = (ContentEdit.PreText = class PreText extends ContentEdit.Text {    declare _cached: any;
    declare _lastCached: any;
    declare content: any;

    static declare TAB_INDENT: any;
    static declare droppers: any;
    static declare mergers: any;
