...
var _getChildNodeAndOffset = function(parentNode, parentOffset) {
    ...
    const childStack = ((() => {
        const result = [];
        for (n of Array.from(parentNode.childNodes)) {             result.push(n);
        }
        return result;
    })());
                ...
                // the stack to be processed.
                    ...
                    if (childNode.childNodes) {
                        Array.prototype.unshift.apply(
                            ...
                            ((() => {
                            const result1 = [];
                            for (n of Array.from(childNode.childNodes)) {                                 result1.push(n);
                            }
                            return result1;
                        })())
                            );
                ...
                // the stack to be processed.
                    ...
                    if (otherChildNode.childNodes) {
                        Array.prototype.unshift.apply(
                            ...
                            ((() => {
                            const result1 = [];
                            for (n of Array.from(otherChildNode.childNodes)) {                                 result1.push(n);
                            }
                            return result1;
                        })())
                            );
