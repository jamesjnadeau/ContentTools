...
HTMLString.Character = class Character {
    ...
    tags() {
        ...
        return (Array.from<any>(this._tags).map((t) => t.copy()));
    }
    ...
    addTags(...tags) {
        ...
        return (() => {
            const result = [];
            for (var tag of Array.from<any>(tags)) {
    ...
    eq(c) {
        ...
        const tags = {};
        for (tag of Array.from<any>(this._tags)) {
            tags[tag.head()] = true;
        }
    ...
    hasTags(...tags) {
        ...
        // exact tag.
        for (tag of Array.from<any>(tags)) {
    ...
    copy() {
        ...
        return new HTMLString.Character(this._c, (Array.from<any>(this._tags).map((t) => t.copy())));
    }
};
