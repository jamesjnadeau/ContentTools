import type {FSMNamespace} from '../../src/core/namespaces.js';

/* A tiny finite state machine, used by HTMLString's parser.
 *
 * This is the one file with no CoffeeScript original and no upstream
 * repository -- HTMLString vendored it as prebuilt JavaScript. Unwrapped from
 * its IIFE and given an export here; the logic is untouched.
 */
...
const FSM = {} as unknown as FSMNamespace;
